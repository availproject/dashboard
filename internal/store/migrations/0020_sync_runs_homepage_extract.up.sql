-- Add 'homepage_extract' scope for homepage AI extraction runs.
CREATE TABLE sync_runs_new (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    team_id     INTEGER REFERENCES teams(id) ON DELETE CASCADE,
    scope       TEXT    NOT NULL CHECK(scope IN ('team', 'org', 'notion_workspace', 'github_repo', 'github_project', 'metrics_url', 'classify', 'homepage_extract')),
