-- Remove new purpose values; rows with new purposes are deleted first.
DELETE FROM source_configs WHERE purpose IN ('project_homepage','goals_doc','sprint_doc','github_repo');
