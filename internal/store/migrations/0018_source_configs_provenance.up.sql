...
INSERT INTO source_configs_new(id,catalogue_id,team_id,purpose,config_meta,created_at) SELECT id,catalogue_id,team_id,purpose,config_meta,created_at FROM source_configs;
